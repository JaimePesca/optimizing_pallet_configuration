...
The improvement translates into 181 to 1{,}514 additional boxes packed
per flight (15{,}411 additional boxes across all 16~flights) and an
estimated 8\% reduction in unit freight costs, confirmed as
statistically significant via a one-sided Wilcoxon signed-rank test
($W=135$, $p<0.0001$).
\end{abstract}
...
total aircraft internal volume $\approx$735\,m$^3$).
...
In absolute terms, BL packs 181 to 1{,}514 additional boxes per flight
beyond the historical loading, totalling 15{,}411 additional boxes
across all 16~flights (minimum: F12, 181~boxes; maximum: F08,
1{,}514~boxes).
...
costs.
The 15{,}411 additional boxes packed across all 16~flights correspond
to an approximately 8\% increase in cargo throughput per charter cycle,
translating to an estimated 8\% reduction in unit freight costs for
the SC.
